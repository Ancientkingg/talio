...
class CardTest {
    ...
    @Test
    void comparisonTest() {
        Card card = new Card("Do all my tasks", 1, "1. task 1; 2. task 2", t1);
        Card card2 = new Card("Do all my tasks", 1, "1. task 1; 2. task 2", t1);
        Card card3 = new Card("Do all my tasks", 2, "1. task 1; 2. task 2", t1);
        Card card4 = new Card("Do all my tasks", 0, "1. task 1; 2. task 2", t1);
    ...
    void testEquals() {
        Card card = new Card("Do all my tasks", 0, "1. task 1; 2. task 2", t1);
        Card card2 = new Card("Do all my tasks", 0, "1. task 1; 2. task 2", t1);
        Card card3 = new Card("Do all my tasks", 0, "1. task 1; 2. task 2", t2);
        Card card4 = new Card("Not all my tasks", 0, "1. task 1; 2. task 2", t2);
        Card card5 = new Card("Do all my tasks", 0, "test", t2);
        Card card6 = new Card("Do all my tasks", 1, "1. task 1; 2. task 2", t1);
